...
final class QueueSubmittedForApproval extends AbstractDomainEvent implements AuditableAction
{
    public function __construct(
        ClockInterface $clock,
        private readonly string $queueId,
        private readonly string $submittedByUserId,
    ) {
    ...
    {
        return 'queues.queue_submitted_for_approval';
    }
