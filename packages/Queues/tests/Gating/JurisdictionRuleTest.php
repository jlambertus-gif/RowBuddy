...
it('is not effective before its start date', function () {
    $rule = new JurisdictionRule('US', null, true, new DateTimeImmutable('2026-06-01'), null);
...
it('is not effective on or after its end date', function () {
    $rule = new JurisdictionRule('US', null, true, new DateTimeImmutable('2026-01-01'), new DateTimeImmutable('2026-06-01'));
...
it('a null category applies to every category', function () {
    $rule = new JurisdictionRule('US', null, true, new DateTimeImmutable('2026-01-01'), null);
...
it('a specific category only applies to itself', function () {
    $rule = new JurisdictionRule('US', 'concert', true, new DateTimeImmutable('2026-01-01'), null);
