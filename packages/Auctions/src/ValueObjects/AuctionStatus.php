 ...
 * aggregate). Sprint 1 only needs the slice the roadmap's Phase 3 exit
 * criteria requires: "an auction can run end-to-end (open → closing →
 * winning bid selected)". Seller-initiated withdrawal/cancellation is
 * deliberately out of scope for this sprint, not silently folded into
 * Expired — revisit when that behavior is actually implemented.
 */
