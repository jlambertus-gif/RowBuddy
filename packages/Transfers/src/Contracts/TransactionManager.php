...
/**
 * Framework-agnostic transaction boundary, mirroring Bids' and Payments'
 * own copies of this same contract — each module owns its own rather
 * than sharing one. The real implementation wraps Laravel's
