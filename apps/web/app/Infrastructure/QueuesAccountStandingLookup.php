...
/**
 * Bridges Queues' read-only {@see AccountStandingLookup} port to
 ...
 * uses. `packages/Queues` never depends on Administration directly.
 */
final class QueuesAccountStandingLookup implements AccountStandingLookup
{
