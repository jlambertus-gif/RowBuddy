...
final class PublishQueueController extends Controller
{
    ...
    public function __invoke(string $queueId, QueueModerationService $service): JsonResponse
    {
        ...
        return response()->json(['data' => $this->toResponse($queue), 'message' => __('queues.moderation.published')]);
    }
}
