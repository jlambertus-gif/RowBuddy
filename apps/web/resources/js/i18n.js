...
i18next.use(initReactI18next).init({
    resources: {
        en: { common: commonEn, queues: queuesEn, presence: presenceEn, disputes: disputesEn, audit: auditEn, auctions: auctionsEn, payments: paymentsEn, transfers: transfersEn, auth: authEn },
        es: { common: commonEs, queues: queuesEs, presence: presenceEs, disputes: disputesEs, audit: auditEs, auctions: auctionsEs, payments: paymentsEs, transfers: transfersEs, auth: authEs },
    },
