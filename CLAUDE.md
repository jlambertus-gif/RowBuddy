...
Auctions–Presence contract and the minimum confidence tier; Sprints 1–3
(`Auction` aggregate scaffold, persistence, and the ADR-009/ADR-010
verification contract and Evidence Verified gate) are complete. See
